...
export const games: Game[] = [
  ...
  },
  {
    id: 'chess-lite',
    title: 'Chess Lite',
    description: 'Simplified chess with essential pieces and classic strategy.',
    icon: <Crown className="h-8 w-8" />,
    difficulty: 'Hard',
    estimatedTime: '15-30 min',
    players: 2,
    rules: [
      'Simplified chess with King, Queen, Rook, Bishop, Knight, and Pawns',
      'Each piece moves according to traditional chess rules',
      'Capture the opponent\'s King to win',
      'Special moves like castling and en passant are included',
    ],
    howToPlay: 'Click on a piece to see its possible moves, then click on a destination square. Think strategically!',
  },
  {
